...
%% =========================================================
% SAVE A_unstable, B_unstable, K_unstable, om_unstable FOR
% DOWNSTREAM SCRIPTS (e.g. full_pipeline.m can load these
% directly instead of recomputing them, if you prefer)
% =========================================================

save('system_model.mat', 'A_unstable', 'B_unstable', 'K_unstable', ...
     'om_unstable', '-append');
...
saveas(gcf, 'fig2_regimes_4panel.png')
